webpackJsonp([ 0, 1 ], [ function(e, t) {
    ...
    function r() {
        return function(e, t) {
            var n, r = t || "project/";
            return n = i.isString(e) ? e : i.get(e, "metadata.name", ""), r.endsWith("/") || (r += "/"), 
            r + n;
        };
    }
    t.__esModule = !0;
    var i = n(0);
    t.projectUrlFilter = r;
}, function(e, t, n) {
    "use strict";
    t.__esModule = !0;
    var r = n(0), i = function() {
        ...
        return e.prototype.makeAPIObjects = function(e) {
            ...
            return n && (i = i.concat(this.makeService(e, n), this.makeRoute(e, n))), i;
    ...
    var r = n(1), i = n(0), s = function() {
        function e(e, t, n, r, i, s) {
            this.ctrl = this, this.$scope = e, this.$filter = t, this.AuthService = i, this.AuthorizationService = s, 
            this.ProjectsService = n, this.Logger = r;
        }
        return e.prototype.$onInit = function() {
            var e = this;
    ...
    s.$inject = [ "$scope", "$filter", "ProjectsService", "Logger", "AuthService", "AuthorizationService" ], 
