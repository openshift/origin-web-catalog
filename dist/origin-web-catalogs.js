webpackJsonp([ 0, 1 ], [ function(e, t) {
    ...
    var i = function() {
        ...
        return e.prototype.getImage = function() {
            ...
            return a.get(this.resource, [ "osbMetadata", "console.openshift.io/iconClass" ], "fa fa-cubes");
        }, e.prototype.getName = function() {
            return a.get(this.resource, "osbMetadata.displayName", this.resource.metadata.name);
        }, e.prototype.getDescription = function() {
            return a.get(this.resource, "osbMetadata.description", "");
    ...
    "use strict";
    t.__esModule = !0;
    var r = n(1), a = n(0), s = n(41), i = function() {
        ...
        return e.prototype.$onInit = function() {
            ...
            return e.from && "ImageStreamTag" === e.from.kind && e.from.name.indexOf(":") === -1 && !e.from.namespace;
    ...
    var r = n(1), a = n(0), s = function() {
        ...
        return e.prototype.$onInit = function() {
            ...
            if (this.isNewProject()) {
                ...
                this.DataService.create("projectrequests", null, a, this.$scope).then(function(t) {
                    e.createService();
                }, function(t) {
                    var n = t.data || {};
    ...
    s.$inject = [ "$element", "$scope", "$filter", "ProjectsService", "Logger", "AuthService", "DataService", "Constants", "AlertMessageService" ], 
    ...
    "use strict";
    t.__esModule = !0;
    var r = n(1), a = n(0), s = n(3), i = function() {
        ...
        return e.prototype.$onInit = function() {
            ...
            var e = s(".sub-cat-card.active"), t = e.find(".card-view-pf").outerHeight();
            e.css("margin-bottom", t + "px");
        }, e.prototype.updateActiveCardStyles = function() {
            s(".sub-cat-card").css("margin-bottom", ""), this.$timeout(this.resizeExpansion, 50);
        }, e;
    }();
