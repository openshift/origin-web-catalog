webpackJsonp([ 0, 1 ], [ function(e, t) {
    ...
    var n = r(1), i = r(0), a = function() {
        ...
        return e.prototype.getCatalogItems = function(e) {
            ...
            var i = this;
            if (void 0 === t && (t = !0), void 0 === r && (r = !0), void 0 === n && (n = !1), 
            "openshift" === e) {
                var a = [];
                return this.$q.when([ a, "" ]);
            }
            var s = this.$q.defer(), o = {
                imageStreams: [],
                templates: []
            }, c = 0, l = 0, d = [], p = this.apiService.getPreferredVersion("imagestreams"), h = this.apiService.getPreferredVersion("templates");
            return t && (c++, this.dataService.list(p, {
                namespace: e
            }).then(function(e) {
                o.imageStreams = e.by("metadata.name");
            }, function() {
                d.push("builder images");
            }).finally(function() {
                i.returnCatalogItems(s, o, ++l, c, d);
            })), r && (c++, this.dataService.list(h, {
                namespace: e
            }, null, {
                partialObjectMetadataList: n
            }).then(function(e) {
                o.templates = e.by("metadata.name");
            }, function() {
                d.push("templates");
            }).finally(function() {
                i.returnCatalogItems(s, o, ++l, c, d);
