webpackJsonp([ 0, 1 ], [ function(e, t) {
    ...
    var r = n(1), s = n(0), a = function() {
        function e(e, t, n, a, i, c, o, l, d) {
            ...
            this.init = function() {
                p.ctrl.loading = !0, p.ctrl.orderingPanelVisible = !1, p.watches.push(p.DataService.watch("projects", p.$scope, p.onProjectsUpdate)), 
                ...
                }), p.$scope.$watch(p.getgetRecentlyViewedItemsFromStorage, function(e) {
                    p.ctrl.recentlyViewedItems = p.getRecentlyViewedItems(e);
                });
        ...
        return e.prototype.$onInit = function() {
            ...
            "ImageStream" === s.get(e, "resource.kind") ? (this.ctrl.selectedImageStream = e, 
            this.ctrl.selectedServiceClass = null) : (this.ctrl.selectedImageStream = null, 
            this.ctrl.selectedServiceClass = e), this.ctrl.openOrderingPanel();
        }, e.prototype.showAllProjects = function() {
            var e = this.ctrl.showProjects();
            e && e();
        }, e.prototype.getRecentlyViewedItems = function(e) {
            return e = e ? JSON.parse(e) : [], e = s.map(e, function(e) {
                return JSON.parse(e);
            });
        }, e.prototype.getgetRecentlyViewedItemsFromStorage = function() {
    ...
    var r = n(1), s = n(0), a = n(3), i = function() {
        function e(e, t, n, r, a) {
            ...
            this.handleClick = function(e, t) {
                ...
                i.ctrl.selectedServiceClass = e), i.setRecentlyViewed(), i.ctrl.openOrderingPanel();
            }, this.closeOrderingPanel = function() {
        ...
        }, e.prototype.setRecentlyViewed = function() {
            var e = this.ctrl.selectedImageStream || this.ctrl.selectedServiceClass, t = localStorage.getItem("catalog-recently-viewed-services");
            t = t ? JSON.parse(t) : [], t = s.map(t, function(e) {
                return JSON.parse(e);
            }), t.map(function(t, n, r) {
                t.resource.metadata.uid === e.resource.metadata.uid && r.splice(n, 1);
            }), t.length >= 3 && t.pop(), t = s.map(t, function(e) {
                return JSON.stringify(e);
            }), t.unshift(JSON.stringify(e)), localStorage.setItem("catalog-recently-viewed-services", JSON.stringify(t));
        }, e;
    }();
